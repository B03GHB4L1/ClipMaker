@echo off
title ClipMaker v1.2.2 by B4L1
cd /d "%~dp0"

echo.
echo  ================================================
echo    ClipMaker v1.2.2 by B4L1 - Starting up...
echo  ================================================
echo.
...
set "SHORTCUT=%DESKTOP%\ClipMaker v1.2.2.lnk"
if not exist "%SHORTCUT%" (
    powershell -NoProfile -NonInteractive -Command ^
        ...
        "$s.Description='ClipMaker v1.2.2 by B4L1';" ^
        "$s.Save()" >nul 2>&1
...
:: STEP 5 - Launch
:: -----------------------------------------------
echo  [..] Opening ClipMaker v1.2.2 in your browser...
echo.
