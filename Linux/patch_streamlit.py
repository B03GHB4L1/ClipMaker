...
def find_streamlit_index():
    ...
    candidates = [
        # Linux — pip --user installs (most common)
        os.path.expanduser("~/.local/lib/python3.12/site-packages/streamlit/static/index.html"),
        ...
        # Linux — Debian/Ubuntu system packages
        "/usr/lib/python3/dist-packages/streamlit/static/index.html",
        "/usr/lib/python3.11/dist-packages/streamlit/static/index.html",
        "/usr/lib/python3.12/dist-packages/streamlit/static/index.html",
        # Linux — Fedora/Arch system packages
        "/usr/lib/python3.11/site-packages/streamlit/static/index.html",
        "/usr/lib/python3.12/site-packages/streamlit/static/index.html",
    ]
    for c in candidates:
        if os.path.exists(c):
            return c
